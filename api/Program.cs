...
string secretKey = configuration["CSRF_SECRET_KEY"] ?? throw new Exception("Missing configuration CSRF_SECRET_KEY");
string tokenName = configuration["CSRF_HEADER_NAME"] ?? throw new Exception("Missing configuration CSRF_HEADER_NAME");
string cookieName = configuration["CSRF_COOKIE_NAME"] ?? throw new Exception("Missing configuration CSRF_COOKIE_NAME");
string domain = configuration["DOMAIN"] ?? throw new Exception("Missing configuration DOMAIN");
...
builder.Services.AddSingleton<CSRFService>(o =>
{
